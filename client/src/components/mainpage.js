            ...
            <div className='bg-[#F9F4ED]'>
                <div className='flex flex-row w-full h-[600px] p-10'>
                    ...
                    <div className='w-1/2 rounded-[20px] flex justify-center overflow-hidden ml-4'>
                        <img src={keyboarding} alt="dsfg" className='rounded-[20px] w-full scale-[1.1]' />
                    </div>
                </div>
            </div>
            <div className='bg-[#2A2A2A]'>
                <div className='flex flex-row w-full h-[680px] p-10'>
                    <div className='p-6  w-1/2 flex flex-col h-full overflow-hidden rounded-[20px] bg-[#F9F4ED]'>
                        <img src={instiimg} className=' h-full scale-[2.8] translate-y-16' />
                    </div>
                    <div className='w-1/2 rounded-[20px] flex flex-col pl-5'>
                        ...
                        <div className='bg-[#2A2A2A] p-4 h-full rounded-2xl border border-white shadow-2xl'>
                            <div className='pt-3 pb-3'><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="flex-none fill-current text-[#F9F4ED] bg-black rounded-full font-bold h-8 w-8">
                            <path d="M12 0c-6.627 0-12 5.373-12 12s5.373 12 12 12 12-5.373 12-12-5.373-12-12-12zm-.001 5.75c.69 0 1.251.56 1.251 1.25s-.561 1.25-1.251 1.25-1.249-.56-1.249-1.25.559-1.25 1.249-1.25zm2.001 12.25h-4v-1c.484-.179 1-.201 1-.735v-4.467c0-.534-.516-.618-1-.797v-1h3v6.265c0 .535.517.558 1 .735v.999z" /></svg></div>
